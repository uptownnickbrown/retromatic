    ...
    <div className="bg-bone/60 border border-navy/8 rounded p-3">
      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-shrink-0 relative group">
          <div className="w-14 h-[70px] bg-paper rounded overflow-hidden border border-navy/8 flex items-center justify-center">
            {option.portraitUrl ? (
              <img
                    ...
                    {isEditing ? (
                      <div className="mt-1 pl-2 border-l-2 border-navy/20">
                        <textarea
                          ...
                          className="w-full p-2 text-sm font-hand italic leading-relaxed text-navy/70
                      ...
                      <div className="mt-1 pl-2 border-l-2 border-navy/10 group/blurb relative">
                        <p className="font-hand text-sm text-navy/60 italic leading-relaxed pr-6">
